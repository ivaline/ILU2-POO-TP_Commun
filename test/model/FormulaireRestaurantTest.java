...
class FormulaireRestaurantTest {
	...
	@Test
	void getJour() {
		assertEquals(JOUR, formulaire.getJour(), "Le jour devrait etre " + JOUR);
	}

	@Test
	void getMois() {
		assertEquals(MOIS, formulaire.getMois(), "Le mois devrait etre " + MOIS);
	}
	...
	void setIdentificationEntite() {
		...
		assertEquals(IDENTIFICATION_1, formulaire2.getIdentificationEntite(),
				"L'identification du formulaire devrait etre " + IDENTIFICATION_1);
		formulaire2.setIdentificationEntite(IDENTIFICATION_2);
		assertEquals(IDENTIFICATION_2, formulaire2.getIdentificationEntite(),
				"L'identification du formulaire devrait etre " + IDENTIFICATION_2);
	}
